...
<!-- wp:group {"align":"full","style":{"color":{"background":"#bfb3fc"}},"className":"btn-rounded form-rounded","paddingTop":14,"paddingBottom":14} -->
<div class="wp-block-group alignfull btn-rounded form-rounded has-background pt__14 pb__14" style="background-color:#bfb3fc"><!-- wp:ainoblocks/grid-container -->
